...
janela.title("REPRODUTOR - RICARDO OLIVEIRA") #Titulo

#Esta parte é que está com problemas
bt_escolher = Button(janela, width=16, text="ADICIONAR MUSICAS", command=player.escolher)
